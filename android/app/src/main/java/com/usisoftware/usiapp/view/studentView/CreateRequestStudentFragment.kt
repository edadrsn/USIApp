            ...
            onSuccess = { documents ->
                try {
                    ...
                    val requestList = documents.map { doc ->
                        ...
                        val categories =
                            doc.getString("requestCategory")?.let { listOf(it) } ?: emptyList()
                        ...
                        Request(
                            ...
                            selectedAcademiciansId = (doc.get("selectedAcademiciansId") as? List<*>)?.filterIsInstance<String>()
                                ?: emptyList(),
                    ...
                    binding.requestStudentRecyclerView.layoutManager =
