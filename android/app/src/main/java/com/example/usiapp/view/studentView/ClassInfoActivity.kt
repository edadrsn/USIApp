...
import com.example.usiapp.databinding.ActivityClassInfoBinding
...
class ClassInfoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Verileri kaydet
        binding.saveClassInfo.setOnClickListener {
    ...
    fun backToProfile(view: View) {
        startActivity(Intent(this@ClassInfoActivity, StudentMainActivity::class.java))
    }
}